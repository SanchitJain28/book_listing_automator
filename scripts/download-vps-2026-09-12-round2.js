...
const vpsList = [
  { id: 1, ip: "162.35.163.93", chunkFile: "chunk-1-vps1.json" },
  { id: 2, ip: "153.75.235.165", chunkFile: "chunk-2-vps2.json" },
  { id: 3, ip: "163.245.196.45", chunkFile: "chunk-3-vps3.json" },
  { id: 4, ip: "153.75.235.158", chunkFile: "chunk-4-vps4.json" },
  { id: 5, ip: "163.245.196.35", chunkFile: "chunk-5-vps5.json" },
];

const pass = "Sanchit@282930";
const remoteBaseDir = "book_listing_automator/output/amazon-india/isbns/2026-09-12/chunks-2";
const localTargetDir = path.join(
  __dirname,
  "../output/amazon-india/isbns/2026-09-12/chunks-2"
);

fs.mkdirSync(localTargetDir, { recursive: true });

console.log("==================================================");
console.log("🚀 Extracting 2026-09-12 Round 2 output chunks from all 5 VPS servers...");
