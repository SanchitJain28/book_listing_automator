...
const remoteBaseDir = "book_listing_automator/output/amazon-india/isbns/2026-09-12/chunks";
const localTargetDir = path.join(
  __dirname,
  "../output/amazon-india/isbns/2026-09-12/chunks"
);

fs.mkdirSync(localTargetDir, { recursive: true });

console.log("==================================================");
console.log("🚀 Extracting 2026-09-12 output chunks from all 5 VPS servers...");
