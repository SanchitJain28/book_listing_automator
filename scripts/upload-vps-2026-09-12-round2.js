...
const remoteChunksDir = "~/book_listing_automator/input-data/amazon-india/isbns/2026-09-12/chunks-2";
const localChunksDir = path.join(__dirname, "../input-data/amazon-india/isbns/2026-09-12/chunks-2");

console.log("==================================================");
console.log("🚀 Uploading 2026-09-12 Round 2 Chunks to all 5 VPS Servers");
console.log("==================================================\n");
