...
const vpsList = [
  ...
  { id: 5, ip: "163.245.196.35", chunkFile: "chunk-4-vps5.json" },
];

const pass = "Sanchit@282930";
const remoteBaseDir = "book_listing_automator/output/amazon-india/isbns/2026-09-09/chunks";
const localTargetDir = path.join(
  __dirname,
  "../output/amazon-india/isbns/2026-09-09/chunks"
);

fs.mkdirSync(localTargetDir, { recursive: true });

console.log("==================================================");
console.log("🚀 Extracting 2026-09-09 output chunks from VPS 1, 3, 5...");
