...
const remoteChunksDir = "~/book_listing_automator/input-data/amazon-india/isbns/2026-09-12/chunks";
const localChunksDir = path.join(__dirname, "../input-data/amazon-india/isbns/2026-09-12/chunks");

console.log("==================================================");
console.log("🚀 Uploading 2026-09-12 Chunks to all 5 VPS Servers");
console.log("==================================================\n");
