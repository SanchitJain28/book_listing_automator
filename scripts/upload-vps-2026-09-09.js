...
const vpsList = [
  { id: 1, ip: "162.35.163.93", chunkFile: "chunk-2-vps1.txt" },
  { id: 3, ip: "163.245.196.45", chunkFile: "chunk-3-vps3.txt" },
  { id: 5, ip: "163.245.196.35", chunkFile: "chunk-4-vps5.txt" },
];

const pass = "Sanchit@282930";
const remoteChunksDir = "~/book_listing_automator/input-data/amazon-india/isbns/2026-09-09/chunks";
const localChunksDir = path.join(__dirname, "../input-data/amazon-india/isbns/2026-09-09/chunks");

console.log("==================================================");
console.log("🚀 Uploading 2026-09-09 Chunks to VPS 1, VPS 3, VPS 5");
console.log("   (VPS 2 and VPS 4 are skipped)");
console.log("==================================================\n");
